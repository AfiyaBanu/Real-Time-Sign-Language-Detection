...
class Application:
    ...
    def __init__(self):
        ...
        self.T.config(text = "Sign Language To Text Conversion", font = ("Courier", 10, "bold"))
    ...
    def destructor(self):
        print(self.str)
        engine.say(self.str or self.word)
        engine.runAndWait()
